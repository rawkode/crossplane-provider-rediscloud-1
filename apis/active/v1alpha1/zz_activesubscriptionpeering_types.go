...
type ActiveSubscriptionPeeringInitParameters struct {
...
type ActiveSubscriptionPeeringObservation struct {
...
type ActiveSubscriptionPeeringParameters struct {
...
// ActiveSubscriptionPeeringSpec defines the desired state of ActiveSubscriptionPeering
type ActiveSubscriptionPeeringSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ActiveSubscriptionPeeringParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ActiveSubscriptionPeeringInitParameters `json:"initProvider,omitempty"`
}

// ActiveSubscriptionPeeringStatus defines the observed state of ActiveSubscriptionPeering.
type ActiveSubscriptionPeeringStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ActiveSubscriptionPeeringObservation `json:"atProvider,omitempty"`
}
...
// ActiveSubscriptionPeering is the Schema for the ActiveSubscriptionPeerings API.
...
type ActiveSubscriptionPeering struct {
	...
	Spec   ActiveSubscriptionPeeringSpec   `json:"spec"`
	Status ActiveSubscriptionPeeringStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ActiveSubscriptionPeeringList contains a list of ActiveSubscriptionPeerings
type ActiveSubscriptionPeeringList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ActiveSubscriptionPeering `json:"items"`
}

// Repository type metadata.
var (
	ActiveSubscriptionPeering_Kind             = "ActiveSubscriptionPeering"
	ActiveSubscriptionPeering_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ActiveSubscriptionPeering_Kind}.String()
	ActiveSubscriptionPeering_KindAPIVersion   = ActiveSubscriptionPeering_Kind + "." + CRDGroupVersion.String()
	ActiveSubscriptionPeering_GroupVersionKind = CRDGroupVersion.WithKind(ActiveSubscriptionPeering_Kind)
)

func init() {
	SchemeBuilder.Register(&ActiveSubscriptionPeering{}, &ActiveSubscriptionPeeringList{})
}
